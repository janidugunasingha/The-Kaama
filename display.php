...
<h1 class="text-center my-3">Payment Managment </h1>
    <div class = "container">
        <button class="btn btn-primary my-5"><a href = "cash.php" class="text-light" >cash payment</a></button>
        
        <button class="btn btn-primary my-5"><a href = "report.php" class="text-light" >Report</a> </button>
...
<form class="d-none d-md-flex ms-4" method="post" action="display.php">
                ...
                <button class="btn btn--radius-2 btn--red btn-warning"  type="submit">Search </button></br></br>
            </form>
    <table class="table">
  <thead>
    <tr>
