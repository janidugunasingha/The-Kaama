...
<img src='./images/popular/healthyredsmoothie.jpg'>
  ...
  <div class="container-fluid">
    <h2 class="text-center">Welcome To Food.lk</h2>
    <div class="content">
  ...
  <div class="modal fade" id="menuUpdate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="updateUser" action="malki_update_menu.php" method="post">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="addUser" action="malki_add_menu.php" method="post">
