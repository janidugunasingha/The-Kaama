...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
    	<div class="container">
	        <a class="navbar-brand" href="welcome.php">E-Restaurant</a>
...
<p></p>
		<main class="login-form">
	        ...
	        <div class="row justify-content-center">
	            <div class="col-md-10">
                <a  href="report.php?userId=<?php echo $_SESSION['user_id'];?>" class="btn btn-labeled btn-dark mb-4">
                    <span class="btn-label"><i class="fa fa-trash"></i></span> Print Users
                </a>
	                <div class="card">
